...
const en: ShareCopy = {
    ...
    liveSnapshotNote: 'While you are signed in with Kira HRT Tracker open, later dosage changes are copied to this link. Lab results, weight, profile details, and account data are not included.',
    ...
    publicEyebrow: 'Kira HRT Tracker · read-only snapshot',
    sharedOn: 'Shared',
    expiresOn: 'Expires',
...
const copy: Record<Lang, ShareCopy> = {
    ...
    zh: {
        ...
        liveSnapshotNote: '登录并打开 Kira HRT Tracker 时，后续用药修改会自动同步至此链接；检查结果、体重、个人资料和账户数据不会被包含。',
        ...
        publicTitle: '分享的用药记录', publicEyebrow: 'Kira HRT Tracker · 只读快照', sharedOn: '分享于', expiresOn: '过期于', neverExpires: '永不过期', protected: '密码保护',
    ...
    'zh-TW': {
        ...
        liveSnapshotNote: '登入並開啟 Kira HRT Tracker 時，之後的用藥修改會自動同步至此連結；檢查結果、體重、個人資料與帳戶資料不會被包含。',
        ...
        publicTitle: '分享的用藥紀錄', publicEyebrow: 'Kira HRT Tracker · 唯讀快照', sharedOn: '分享於', expiresOn: '到期於', neverExpires: '永不到期', protected: '密碼保護',
    ...
    yue: {
        ...
        liveSnapshotNote: '登入並開住 Kira HRT Tracker 時，之後嘅用藥修改會自動同步到呢條連結；檢查結果、體重、個人資料同帳戶資料唔會包括。',
        liveToggle: '即時同步', liveBadge: '即時', updatedOn: '更新於',
        ...
        publicTitle: '分享嘅用藥紀錄', publicEyebrow: 'Kira HRT Tracker · 唯讀快照', sharedOn: '分享於', expiresOn: '到期於', neverExpires: '永不到期', protected: '密碼保護',
    ...
    ja: {
        ...
        liveSnapshotNote: 'Kira HRT Trackerにログインして開いている間、以後の投与変更がこのリンクへ自動同期されます。検査結果、体重、プロフィール、アカウント情報は含まれません。',
        ...
        publicTitle: '共有された投与記録', publicEyebrow: 'Kira HRT Tracker · 閲覧専用スナップショット', sharedOn: '共有日時', expiresOn: '有効期限', neverExpires: '期限なし', protected: 'パスワード保護',
    ...
    ko: {
        ...
        liveSnapshotNote: 'Kira HRT Tracker에 로그인한 상태로 앱을 열어 두면 이후 복용 변경 사항이 이 링크에 자동 동기화됩니다. 검사 결과, 체중, 프로필 및 계정 정보는 포함되지 않습니다.',
        ...
        publicTitle: '공유된 복용 기록', publicEyebrow: 'Kira HRT Tracker · 읽기 전용 스냅샷', sharedOn: '공유', expiresOn: '만료', neverExpires: '만료 없음', protected: '비밀번호 보호',
    ...
    tr: {
        ...
        liveSnapshotNote: 'Kira HRT Tracker açık ve oturumunuz etkin olduğu sürece sonraki doz değişiklikleri bu bağlantıya otomatik eşitlenir. Test sonuçları, kilo, profil ve hesap verileri dahil edilmez.',
        ...
        publicTitle: 'Paylaşılan doz kaydı', publicEyebrow: 'Kira HRT Tracker · salt okunur anlık görüntü', sharedOn: 'Paylaşıldı', expiresOn: 'Sona erer', neverExpires: 'Süresiz', protected: 'Parola korumalı',
